...
class Solicitacao
{
    ...
    /**
     * @var \LQNL\ServidorBundle\Entity\Catador
     */
    private $catador;

    /**
     * @var \LQNL\ServidorBundle\Entity\Disponibilidade
     */
     ...
     * Set catador
     *
     * @param \LQNL\ServidorBundle\Entity\Catador $catador
     * @return Solicitacao
     */
    public function setCatador(\LQNL\ServidorBundle\Entity\Catador $catador = null)
    {
     ...
     * Get catador
     *
     * @return \LQNL\ServidorBundle\Entity\Catador 
     */
     ...
     *
     * @param \LQNL\ServidorBundle\Entity\Disponibilidade $disponibilidade1
     * @return Solicitacao
     */
    public function setDisponibilidade1(\LQNL\ServidorBundle\Entity\Disponibilidade $disponibilidade1 = null)
    {
     ...
     *
     * @return \LQNL\ServidorBundle\Entity\Disponibilidade 
     */
     ...
     *
     * @param \LQNL\ServidorBundle\Entity\Disponibilidade $disponibilidade2
     * @return Solicitacao
     */
    public function setDisponibilidade2(\LQNL\ServidorBundle\Entity\Disponibilidade $disponibilidade2 = null)
    {
     ...
     *
     * @param \LQNL\ServidorBundle\Entity\Disponibilidade $disponibilidade3
     * @return Solicitacao
     */
    public function setDisponibilidade3(\LQNL\ServidorBundle\Entity\Disponibilidade $disponibilidade3 = null)
    {
     ...
     * Set usuario
     *
     * @param \LQNL\ServidorBundle\Entity\Usuario $usuario
     * @return Solicitacao
     */
    public function setUsuario(\LQNL\ServidorBundle\Entity\Usuario $usuario = null)
    {
